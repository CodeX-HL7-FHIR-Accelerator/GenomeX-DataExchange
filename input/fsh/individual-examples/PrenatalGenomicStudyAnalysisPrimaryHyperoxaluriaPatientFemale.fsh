Instance: PrenatalGenomicStudyAnalysisPrimaryHyperoxaluriaPatientFemale
...
* extension[=].extension[=].valueCodeableConcept = $refseq#NM_000030 "Exons: NM_000030:1-11"
* extension[+].url = "http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomic-study-analysis-regions"
* extension[=].extension[0].url = "description"
* extension[=].extension[=].valueString = "Genes studied"
* extension[=].extension[+].url = "studied"
* extension[=].extension[=].valueCodeableConcept = $genenames#HGNC:341 "AGXT"
...
* note[0].text = "primary hyperoxaluria type 1 - AGXT. Autosomal recessive inheritance. sequencing with copy number analysis. Detection rate: Northern European >99%"
* note[+].text = "No disease-causing mutations were detected in any other gene tested for primary hyperoxaluria type 1"
