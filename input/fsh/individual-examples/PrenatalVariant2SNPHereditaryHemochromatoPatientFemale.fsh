Instance: PrenatalVariant2SNPHereditaryHemochromatoPatientFemale
...
* component[=].valueCodeableConcept = $varnomen#NM_000410.3:c.187C>G "NM_000410.3(HFE):c.187C>G(H63D) heterozygote"
