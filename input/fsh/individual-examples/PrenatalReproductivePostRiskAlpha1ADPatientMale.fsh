Instance: PrenatalReproductivePostRiskAlpha1ADPatientMale
...
* basis[0] = Reference(PrenatalResidualRiskAlpha1ADPatientMale)
* basis[+] = Reference(PatientMale)
* prediction.outcome.text = "Reproductive risk for inheriting a disease-causing mutation for alpha-1 antitrypsin deficiency after Prenatal test"
* prediction.probabilityDecimal = 0.009098611015817493
