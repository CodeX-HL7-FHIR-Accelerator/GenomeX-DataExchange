Instance: PrenatalReproductivePreRiskAlpha1ADPatientMale
...
* prediction.outcome.text = "Risk for inheriting a disease-causing mutation for alpha-1 antitrypsin deficiency before Prenatal test"
* prediction.probabilityDecimal = 0.0003310162197947699
