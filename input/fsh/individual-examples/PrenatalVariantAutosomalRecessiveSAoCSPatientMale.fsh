Instance: PrenatalVariantAutosomalRecessiveSAoCSPatientMale
...
* component[=].valueCodeableConcept = $loinc#LA21266-4 "Chromosome 13"
* component[+].code = $loinc#48018-6 "Gene studied [ID]"
* component[=].valueCodeableConcept = $genenames#HGNC:10519 "SACS"