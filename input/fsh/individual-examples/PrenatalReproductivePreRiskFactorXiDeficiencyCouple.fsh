Instance: PrenatalReproductivePreRiskFactorXiDeficiencyCouple
...
* prediction.outcome.text = "Risk for inheriting a disease-causing mutation for factor XI deficiency before Prenatal test"
