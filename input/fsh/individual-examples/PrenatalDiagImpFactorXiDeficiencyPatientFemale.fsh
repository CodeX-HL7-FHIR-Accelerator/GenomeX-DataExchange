Instance: PrenatalDiagImpFactorXiDeficiencyPatientFemale
...
* extension.valueReference = Reference(PrenatalResidualRiskFactorXiDeficiencyPatientFemale) "factor XI deficiency Residual Risk"
* status = #final
...
* derivedFrom = Reference(PrenatalVariantFactorXiDeficiencyPatientFemale)
