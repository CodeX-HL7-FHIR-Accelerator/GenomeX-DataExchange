Instance: PrenatalGenomicStudyAnalysisFamilialHyperinsulinismPatientMale
...
* extension[=].extension[=].valueCodeableConcept = $refseq#NM_000352 "Exons: NM_000352:1-39"
* extension[+].url = "http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/genomic-study-analysis-regions"
* extension[=].extension[0].url = "description"
* extension[=].extension[=].valueString = "Genes studied"
* extension[=].extension[+].url = "studied"
* extension[=].extension[=].valueCodeableConcept = $genenames#HGNC:59 "ABCC8"
...
* note[0].text = "familial hyperinsulinism, ABCC8-related - ABCC8. Autosomal recessive inheritance. sequencing with copy number analysis. Detection rate: Northern European >99%"
* note[+].text = "No disease-causing mutations were detected in any other gene tested for familial hyperinsulinism, ABCC8-related"
