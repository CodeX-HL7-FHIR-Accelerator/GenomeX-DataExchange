Instance: PrenatalDiagImpGlycogenStorageDiseasePatientMale
...
* extension.valueReference = Reference(PrenatalResidualRiskGlycogenStorageDiseasePatientMale) "glycogen storage disease type III Residual Risk"
* status = #final
...
* derivedFrom = Reference(PrenatalVariantGlycogenStorageDiseaseTypePatientMale)
