Instance: PrenatalReproductivePostRiskFamilialHyperinsulinismPatientMale
...
* basis[0] = Reference(PrenatalResidualRiskFamilialHyperinsulinismPatientMale)
* basis[+] = Reference(PatientMale)
* prediction.outcome.text = "Reproductive risk for inheriting a disease-causing mutation for familial hyperinsulinism, ABCC8-related after Prenatal test"
* prediction.probabilityDecimal = 8.53310747471998e-8
