Instance: PrenatalVariantPrimaryHyperoxaluriaPatientFemale
...
* component[=].valueCodeableConcept = $loinc#LA21255-7 "Chromosome 2"
* component[+].code = $loinc#48018-6 "Gene studied [ID]"
* component[=].valueCodeableConcept = $genenames#HGNC:341 "AGXT"