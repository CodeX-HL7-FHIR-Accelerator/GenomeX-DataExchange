Instance: PrenatalReproductivePreRiskFamilialHyperinsulinismPatientMale
...
* prediction.outcome.text = "Risk for inheriting a disease-causing mutation for familial hyperinsulinism, ABCC8-related before Prenatal test"
* prediction.probabilityDecimal = 0.000008508465923593976
