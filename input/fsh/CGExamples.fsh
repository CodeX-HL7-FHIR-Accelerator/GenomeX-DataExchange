...
// Add in an open component for predicted phenotype.
* component[2].code.coding = TbdCodesGdxCS#predicted-therapeutic-implication "predicted therapeutic implication"
* component[2].valueCodeableConcept.coding = $LNC#LA25391-6 "Normal metabolizer"
